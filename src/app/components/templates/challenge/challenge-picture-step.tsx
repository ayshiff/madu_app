...
export const ChallengePictureStep = (props: ChallengePictureStepScreenProps) => {
    const { navigation } = props;

    return (
        <Full>
            <ChallengePictureContainer>
                <ChallengePictureTitle>Tu as réussi ton 1er défi !</ChallengePictureTitle>
                <ChallengePictureSubtitle>Gagne le double du butin en immortalisant ton exploit.</ChallengePictureSubtitle>
                <Points points={80}/>

                <ChallengeTakePictureContainer>
                    <ChallengeTakePictureText>Prendre une photo</ChallengeTakePictureText>
                </ChallengeTakePictureContainer>
                <ChallengeChoosePictureContainer>
                    <ChallengeChoosePictureText>Choisir une photo</ChallengeChoosePictureText>
                </ChallengeChoosePictureContainer>
            </ChallengePictureContainer>

            <ChallengePictureDisagreeContainer>
                <ChallengePictureDisagree>Je ne souhaite pas poster d’image </ChallengePictureDisagree>
            </ChallengePictureDisagreeContainer>
        </Full>
    );
};
